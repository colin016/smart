...
<html>
  <head>
    <meta charset="utf-8">
    <title>设备管理-设备列表界面</title>
    <link href="css/equipment_list.css" rel="stylesheet">
...
<div class="theme-buy">
      <a class="btn btn-primary btn-large theme-add" href="javascript:;">添加</a>
     ...
     <div class="theme-popbod dform">
           <form class="theme-signin" name="loginform" action="" method="post">
                <ol>
                     ...
                     <li><strong>设备名称：</strong><input class="ipt" type="text" name="log" value="" size="20" /></li>
                     <li><strong>设备类型：</strong><input class="ipt" type="password" name="pwd" value="" size="20" /></li>
                     <li><strong>设备编号：</strong><input class="ipt" type="text" name="log" value="" size="20" /></li>
                     <li><strong>设备位置：</strong><input class="ipt" type="text" name="log" value="" size="20" /></li>
                     <li><strong>所属媒介：</strong><input class="ipt" type="text" name="log" value="" size="20" /></li>
                     <li><strong>设备状态：</strong><input class="ipt" type="text" name="log" value="" size="20" /></li>
