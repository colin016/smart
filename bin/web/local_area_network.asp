...
<html>
  <head>
    <meta charset="utf-8">
    <title>系统管理-局域网发现管理界面</title>
    <link href="css/local_area_network.css" rel="stylesheet">
...
<!-- 主要内容 -->
    <div id="main_content">
      <h1 id="title">局域网发现管理</h1>
      <div class="main_content">
        <div class="network_list">
          <div class="network_left">消息列表</div>
        ...
        <div class="network_buttom">
          <form action="" method="get" id="judge">
            <p>是否响应：</p>
            <label><input name="choice" type="radio" value="" />是 </label>
            <label><input name="choice" type="radio" value="" />否 </label>
            <input type="submit" value="确定" onclick="" class="su"/>
          </form>
        </div>
      </div>
    </div>
